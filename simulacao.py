...
with st.sidebar:
      with st.form('amostragem'):
            amostra = st.slider(label = 'Selecione o tamanho da amostra:', min_value = 1,
            ...
            bins = st.slider(label = 'Selecione o tamanho de bins:', min_value = 10,
                                max_value = 500, value = 30, step = 10)
            
            n = st.radio(label = 'Selecione a quantidade de repetições do experimento:',
                                 options = [100, 1000, 10000, 100000, 1000000, 10000000], index = 2)
             
            if st.form_submit_button('Repetir experimento'):
                  st.rerun()
